...
var BurnsPage = /** @class */ (function () {
    function BurnsPage(navCtrl, navParams, domSanitizer) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    BurnsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-burns',template:/*ion-inline-start:"F:\OneDrive\Band--Aid\src\pages\burns\burns.html"*/'<!--\n  Generated template for the BurnsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header dir="rtl">\n  <ion-navbar color="orange">\n    <button ion-button menuToggle class="menus">\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title> الحروق </ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n\n<ion-content padding>\n\n\n\n  <div class="con-deta">\n      <a href="#hl">الحرق المباشرة</a>\n    <a href="#hc">الحروق الكيميائية</a>\n    <a href="#he">الحروق الكهربائية</a>\n    <a href="#rt">   الرذاذ الكيميائي في العين</a>\n\n    \n\n  </div>\n\n\n  <ul class="main-ul" dir="rtl">\n\n\n    <li>\n\n      <ul>\n<p id="hl">الحروق المباشرة</p>\n        <p  >الحروق من الدرجة الاولى</p>\n        <li> هي حروق سطحية تصيب الطبقة الخارحية من الجلد من أعراضها الإحمرار, التورم و الاحساس بالالم الشديد\n        </li>\n\n        <p> الحروق من الدرجة الثانية</p>\n        <li>هي حروق متوسطة العمق والتي تمتد الى الطبقة الداخلية من الجلد حيث تتكون فقاعات أو فقاقيع مملوئة بالسوائل\n          تشمل الاعراض الاحمرار, التورم, الالم الشديد و تكون الفقاقيع.\n        </li>\n\n\n        <p> الحروق من الدرجة الثالثة</p>\n        <li>هي حروق عميقة تصيب جميع طبقات الجلد و أحيانا ما تحت الجلد من العضلات و العظام التي قد تتفحم, و تعد هذه\n          الحروق الاخطر لكن في هذه الحالة غالبا لا يحس المصاب بالألم نظرا لإحتراق المستقبلات العصبية التي تتواجد في\n          الجلد.</li>\n\n\n\n\n      </ul>\n      <hr>\n      <ul>\n\n        <p>تنبيه*</p>\n        <li>لا تستعمل الاشياء التالية: الثلج, الماء المثلج, معجون الاسنان, الزبدة أو أي مرهم</li>\n        <li> -لا تضع القطن فوق الحرق كي لا يلتصق.\n        </li>\n\n\n        <p>الهدف</p>\n        <li>الهدف من الإسعاف في هذه الحالة هو تبريد الانسجة التي تعرضت للحرق كي لا تتلف المزيد من الخلايا الاخرى من\n          الحرارة المتواجدة حولها و ذلك بإستعمال المياه الجارية لكن في حالة عدم وجود المياه تغطي الحرق بالكمادات و\n          تتوجه للمستشفى.</li>\n\n\n        <p>المعالجة</p>\n        <li>إبعاد المصاب عن مكان الخطر أو إبعاد الشيء الذي سبب الحروق.\n        </li>\n        <li>إفحص العلامات الحيوية (النبض, مجرى الهواء, التنفس) و قم بإزالة الاكسسوارات (الحلي, الخواتم, الساعة اليدوية\n          ...) وكذا الملابس المحترقة الغير الملتصقة بمكان الحرق.\n        </li>\n        <li> بالنسبة للحروق من الدرجة الاولى\n          يجب تبريد مكان الحرق بالمياه الجارية تحت الصنبور (أو قنينة ماء) بسلاسة لاكثر من 10 دقائق حتى تخف حدة الألم.\n          أطلب المساعدة الطبية إذا زاد أو إستمر الألم و الاحمرار لأكثر من ساعة و كذا عند حدوث التورم و الحمى. </li>\n        <li>بالنسبة للحروق من الدرجة الثانية\n          تغمر مكان الحرق أو تسكب عليه المياه الجارية لكن لا تثقب أو تفتح الفقاقيع الناتجة التي تكون مملوئة بالسوائل و\n          غط الحرق بقماش نظيف أو ضماد معقم يجب التوجه للمستشفى.</li>\n        <li>بالنسبة للحروق من الدرجة الثالثة\n          يجب تغطية مكان الحرق قماش نظيف او ضماد معقم و ثبتها برباط دون إغفال تغطية المصاب والاسراع به للمستشفى.</li>\n\n\n\n      </ul>\n\n      <hr>\n      <ul>\n        <p id="hc">الحروق الكيميائية</p>\n\n        <p>المعالجة</p>\n\n        <li>إبعاد المصاب عن مكان الخطر أو إبعاد المادة المسببة للحرق و القيام بفحص سريع للوظائف الحيوية (الوعي, التنفس\n          و النبض).\n        </li>\n        <li>سكب المياه الجارية بوفرة (مياه الصنبور مثلا) على الفور على الحرق لمدة حوالي 20 دقيقة لمحاولة تخفيف تركيز\n          المادة و تقليل الأضرار لكن إذا كانت المادة المسببة للحرق قد تتفاعل مع الماء و تسبب أضرار أخرى كمادة الجير\n          الحي فيجب محاولة إزالتها أولا.\n        </li>\n\n        <img src="../../assets/imgs/brokenimg/hr1.png" alt="">\n\n        <li>نزع الملابس حول مكان الإصابة.\n        </li>\n        <li>يجب إزالة أي خواتم, مجوهرات, ساعة اليد إن كانت قريبة من مكان الحرق.\n        </li>\n        <li>تغطية المنطقة المصابة بقماش نظيف لا يلتصق أو بشاش طبي غير لاصق.\n        </li>\n        <li>طلب المساعدة الطبية أو طلب سيارة الإسعاف لإسعاف المصاب للمستشفى لإستكمال العلاج.\n        </li>\n\n\n      </ul>\n\n\n    </li>\n\n  </ul>\n\n  <iframe width="100%" height="315" [src]="trustedVideoUrl" frameborder="0" allowfullscreen></iframe>\n\n\n\n\n  <ul class="main-ul" dir="rtl">\n\n\n    <li>\n\n      <ul>\n\n        <p id="he">الحروق الكهربائية</p>\n\n\n        <p>تنبيه*</p>\n        <li>لا تلمس المصاب ما دام متصل بالتيار الكهربائي.\n        </li>\n        <li>لا تلمس مكان الحرق بيدك مباشرة.\n        </li>\n        <li>لا تضع أية مراهم و لا أية مواد فوق مكان الحرق.\n        </li>\n        <li>لا تضع أي ضمادات لاصقة على الحرق.\n        </li>\n\n\n        <p>المعالجة</p>\n\n        <li>قبل التوجه و فحص المصاب يجب أولا قطع أو فصل التيار الكهربائي و لايجب لمس المصاب مباشرة وهو متصل بمصدر\n          الكهرباء ضمانا لسلامتك.كما يمكن إبعاد مصدر الكهرباء بالاستعانة بأداه عازلة غير موصلة للكهرباء (عصا من خشب او\n          بلاستيك مثلا).\n        </li>\n        <img src="../../assets/imgs/brokenimg/hr2.png" alt="">\n        <li>فحص العلامات الحيوية (النبض, التنفس و الوعي) وفي حالة توقف القلب يجب القيام بالانعاش القلبي الرئوي فورا أما\n          إن كان المصاب فاقد للوعي و يتنفس فضعه على جانبه (وضعية الإفاقة).\n        </li>\n        <li>إتصل بسيارة الاسعاف بعد فحص سريع للمصاب أو طلب ذلك من شخص مساعد بجانبك.\n        </li>\n        <li>إرفع الأماكن المصابة فوق مستوى القلب ما أمكن و أزل أي خواتم أو أساور .\n        </li>\n        <li>تبريد مكان الحرق من مكان دخول التيار لمكان خروجه بسكب الماء لمدة 10 دقائق في حالة الحروق من الدرجة الأولى\n          أو الثانية.\n        </li>\n        <li>تغطية مكان الحرق بشاش أو ضمادة غير لاصقة أو بكيس بلاستيكي.\n        </li>\n        <li>راقب حالة المصاب بإنتظار سيارة الاسعاف لنقل المصاب للمستشفى.\n        </li>\n\n      </ul>\n\n    </li>\n<hr>\n\n    <li>\n\n<ul>\n\n  <p>  الرذاذ الكيميائي في العين</p>\n\n  <p>المعالجة</p>\n  <li> اغسل عينك بالماء\n      استخدم ماء صنبور نظيفًا فاترًا لمدة 20 دقيقة على الأقل. استخدم أسرع طريقة من الطرق التالية</li>\n  <li>اذهب للاستحمام ووجه تيارًا لطيفًا من الماء على جبهتك أعلى العين المصابة، أو وجه تيارًا على جسر الأنف في حالة تأثر العينين، واجعلْ جفون العين أو العينين المصابة مفتوحة.</li>\n  <li> وجّه رأسك لأسفل وقم بإدارتها للجانب؛ ثم اجعل جفون العين المصابة مفتوحة أسفل صنبور الماء الجاري برفق، وإذا كان بإمكانك الوصول إلى محطة غسيل العين الموجودة بموقع العمل، فاستخدم المحطة لغسل عينك.</li>\n  <li> اغسل يديك بالماء والصابون\n          بشكل كامل لتتأكد من عدم وجود مواد كيميائية أو صابون عليهما.</li>\n  <li> قم بإزالة العدسات اللاصقة\n      إذا لم تخرج العدسات اللاصقة أثناء الغسل، فقم بإخراجها</li>\n \n\n</ul>\n    </li>\n\n\n  </ul>\n\n\n\n\n\n</ion-content>'/*ion-inline-end:"F:\OneDrive\Band--Aid\src\pages\burns\burns.html"*/,
        }),
...
var ChokingPage = /** @class */ (function () {
    function ChokingPage(navCtrl, navParams, domSanitizer) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.domSanitizer = domSanitizer;
        this.video = {
...
var EmergencyBirthPage = /** @class */ (function () {
    ...
    EmergencyBirthPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-emergency-birth',template:/*ion-inline-start:"F:\OneDrive\Band--Aid\src\pages\emergency-birth\emergency-birth.html"*/'<!--\n  Generated template for the EmergencyBirthPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header dir="rtl">\n  <ion-navbar color="orange">\n    <button ion-button menuToggle class="menus">\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title> الولادة الطارئة  </ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n  \n    <div class="con-deta">\n        <a href="#wl">الولادة</a>\n        <a href="#eg">الاجهاض</a>\n \n\n        \n      </div>\n\n  \n  <ul class="main-ul" dir="rtl">\n\n    <p id="wl"> الولادة الطارئة</p>\n\n    <p>المعالجة</p>\n\n    <li>تحتاج الأم للراحة بين الانقباضات لدى يجب تهدئتها و تشجيعها.</li>\n    <li>يجب أن تضطجع الأم على ظهرها وتبعد ما بين رجليها بعد أن يشتد الطلق والانقباضات, وبذلك يمكن رؤية أول إشارة للولادة.</li>\n    <li>عند بروز رأس الطفل, اغمس يديك في سائل مطهر وأحط بهما الرأس برفق، لا تسحب الرأس أو تشده </li>\n    <img src="../../assets/imgs/brokenimg/wl1.PNG" alt="">\n    <li>متى برز الرأس قل للأم أن تكف عن الدفع، دعها تلهث, هذا يمنع الرأس من البروز بسرعة كبيرة وقد تتوقف الانقباضات بضع دقائق، وقد يدور الرأس، فلا تفعل شيئا بل اسند الرأس بيديك.</li>\n    <img src="../../assets/imgs/brokenimg/wl2.png" alt="">\n    <li>عند بروز المنكبان امسك بالطفل من تحت إبطيه وارفعه و ضعه على بطن الأم,  لاحظ أن الوليد ينزلق، ولهذا أمسك به بإحكام.</li>\n    <img src="../../assets/imgs/brokenimg/wl3.png" alt="">\n    <li>إذا تمت الولادة ضع الوليد فوق بطن الأم برأس منخفض كي يسيل المخاط من الفم والأنف, حاول تنظيف فمه و أنفه. قد يلهث الطفل ويبكى في هذه المرحلة وهذا أمر طبيعي, وهو مقدمة للتنفس الرتيب، </li>\n    <img src="../../assets/imgs/brokenimg/wl4.PNG" alt="">\n    <li>لف الطفل ببطانية أو منشفة, ودع أمه تحتضنه. </li>\n    <li> انتظر خروج المشيمة, وهي تبرز كنسيج أحمر لحمي، تخرج عادة بعد مرور 30 دقيقة من الولادة.</li>\n    <li>اربط بقوة الحبل السري بخيط على مسافة 10 سنتيمترات من سرة الطفل, لا تقطع الحبل الا اذا فقدت الامل في مجي الطبيب أو القابلة.</li>\n\n\n\n    <hr>\n\n    <p id="eg">الاجهاض</p>\n\n    <p>علامات الاجهاض</p>\n\n    <li> ظهور نزيف مهبلي يكون في الاول فاتح و بعدها ثقيل و كثيف.</li>\n    <li>ألم و أوجاع أسفل الظهر.</li>\n    <li>تقلصات شديدة في البطن.</li>\n    <li>حمى و ضعف. </li>\n    <li>إذا ظهرت هذه الأعراض يقتضى استدعاء الطبيب بسرعة أو طلب سيارة إسعاف فوراً</li>\n    <li>قد تكون آلام الظهر، ألم في البطن، أو التقلصات الشديدة علامات تنبأ للإجهاض، حتى من دون ظهور أي نزيف. </li>\n\n   \n    <p>المعالجة</p>\n\n\n<li>بعد فحص سريع للمرأة و ظهور علامات الاجهاض يجب طلب سيارة إسعاف. </li>\n<li>مراقبة العلامات الحيوية (الوعي, النبض و التنفس) . </li>\n<li>قبل وصول الاسعاف ينبغي للمرأة أن تضطجع على فراش مغطى بغطاء من البلاستيك ومنشفة.\n  </li>\n<li>إستلقاء المرأة على الظهر مع إبقاء ركبتيها متباعدتين عن بعضهما البعض ورفعهما قليلا و تلك أفضل وضعية.</li>\n<li>وضع المناشف بين رجليها خصوصا إن بدأ النزيف من المهبل. </li>\n<li>عند توقف النزيف استبدل المناشف بمنديل صحي  للتنظيف و مص ما تبقى من النزف ولكن لا تستعمل سدادة قطنية للمهبل أي لاتستعمل القطن كسدادة. </li>\n\n  </ul>\n\n\n\n</ion-content>\n'/*ion-inline-end:"F:\OneDrive\Band--Aid\src\pages\emergency-birth\emergency-birth.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]])
    ], EmergencyBirthPage);
...
var FaintingPage = /** @class */ (function () {
    function FaintingPage(navCtrl, navParams, domSanitizer) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.domSanitizer = domSanitizer;
        this.video = {
...
var MaxTemperaturesPage = /** @class */ (function () {
    ...
    MaxTemperaturesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-max-temperatures',template:/*ion-inline-start:"F:\OneDrive\Band--Aid\src\pages\max-temperatures\max-temperatures.html"*/'<!--\n  Generated template for the MaxTemperaturesPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header dir="rtl">\n  <ion-navbar color="orange">\n    <button ion-button menuToggle class="menus">\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title> درجة الحرارة القصوى  </ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n\n  \n    <div class="con-deta">\n        <a href="#sad">الصدمة</a>\n        <a href="#sad2">الذبحة الصدرية</a>\n        <a href="#naob">النوبة القلبية</a>\n        <a href="#sthart"> توقف القلب </a>\n        <a href="#stmok"> الجلطة الدماغية </a>\n        \n      </div>\n\n\n\n      \n  <ul class="main-ul" dir="rtl">\n\n<li>\n  <ul>\n\n    <p>الإسعافات الأولية لعضة البرد</p>\n\n    <p>المعالجة</p>\n\n    <li>التمس المساعدة الطبية الطارئة إذا شككت في الإصابة بانخفاض الحرارة، وتتضمن علامات وأعراض انخفاض الحرارة الارتجاف الشديد وتداخل الكلام والنعاس وفقدان التناسق.\n      </li>\n    <li> إذا كنت خارج المنزل، فقم بتدفئة اليدين المصابتين بعضة البرد بدسهما تحت إبطيك، واحمِ وجهك أو أنفك أو أذنيك عن طريق تغطية المنطقة بيدين جافتين مرتديًا القفازات، ولا تفرك المنطقة المصابة، وإياك أن تفرك الجليد على الجلد المصاب بعضة البرد.</li>\n    <li> أعد تدفئة المناطق المصابة بعضة البرد برفق.. انقع اليدين أو القدمين في ماء دافئ من 99 إلى 108 فهرنهايت (من 37 إلى 42 مئوية) لمدة من 15 إلى 30 دقيقة. وإذا لم يتوفر مقياس حرارة، فاختبر الماء بوضع يد أو كوع غير مصاب فيها - حيث ينبغي أن تكون دافئة جدًا- ليست ساخنة.</li>\n    <li>ولا تعد تدفئة الجلد المصاب بعضة البرد بواسطة وسائل الحرارة المباشرة كالموقد أو المصباح الحراري أو المدفأة أو وسادة التدفئة، فيمكن أن يتسبب هذا في حروق.</li>\n    <li> إذا كان هناك أي احتمال أن المناطق المصابة ستتجمد مرة أخرى، فلا تذبها، وإذا تمت إذابتها بالفعل، فقم بلفها حتى لا تتعرض للتجمد مرة أخرى.</li>\n    <li> لا تمشِ على قدمين مصابتين أو أصابع قدم مصابة بعضة البرد.. فهذا يزيد من تلف النسيج.</li>\n    <li>إذا تحول لون الجلد إلى اللون الأحمر وشعرت بوخز وحرق بينما يدفأ الجلد، فهذا يعني عودة تدفق الدم الطبيعي، لكن التمس الرعاية الطبية الطارئة إذا استمر الشعور بالخدر أو الألم أثناء التدفئة أو إذا تطور ظهور البثور.</li>\n\n\n  </ul>\n</li>\n\n\n\n<hr>\n\n<li>\n \n  <ul>\n<p>   حروق الشمس  </p>\n<p>المعالجة</p>\n\n\n<li>خذ حمامًا باردًا\n    أو استحم، وهو ما قد يكون له تأثير مهدئ، أو ضع منشفة نظيفة مبللة بماء صنبور بارد.</li>\n<li> ضع مرطبًا أو غسولاً أو جل الصبار أو كريم هيدروكورتيزون منخفض الجرعة\n    وهو ما قد يوفر الراحة في بعض الحالات</li>\n<li>لا تفقع البثور الصغيرة (التي لا تتعدى في حجمها أظفر إصبع يديك الصغير)</li>\n<li>وفي حالة فقع البثور، نظِّف المنطقة برفق باستخدام ماء وصابون خفيف وقم بوضع مرهم مضاد حيوي على المنطقة، ثم قم بتغطيتها بضمادة غير لاصقة من الشاش.</li>\n<li>يجب زيارة الطبيب في حالة ظهور بثور كبيرة، ويفضل إزالة البثور الكبيرة، نظرًا لأنه نادرًا ما تبقى تلك البثور كما هي؛ واطلب المساعدة الطبية أيضًا إذا عانيت من مضاعفات فورية مثل الألم الشديد أو الصداع أو الارتباك أو الغثيان أو الرعشة.</li>\n\n  </ul>\n\n</li>\n\n\n\n<li>\n  <ul>\n    <p>فقدان حرارة الجسم</p>\n\n    <p>تنبيه*</p>\n\n    <li>لا تقم بإعادة تدفئة الشخص بسرعة جدًا مثلما يتم في حالة استخدام مصباح التدفئة أو الحمام الساخن.</li>\n    <li>لا تحاول تدفئة الذراعين والساقين. قد يؤدي تدفئة وتدليك أطراف شخص ما في هذه الحالة إلى إجهاد القلب والرئتين.</li>\n    <li> لا تعطِ الشخص المشروبات الكحولية أو السجائر. حيث إن الكحوليات تعيق عملية إعادة التدفئة، كما تتعارض منتجات التبغ مع الدورة الدموية الضرورية لعملية إعادة التدفئة.</li>\n\n\n\n    <hr>\n\n    <li>انقل الشخص برفق بعيدًا عن المكان البارد. في حالة عدم التمكن من دخول المنزل، فقم بوقاية الشخص من الرياح خاصةً المنطقة حول الرقبة والرأس. اعزل جسم الشخص عن الأرض الباردة.</li>\n    <li>انزع الملابس المبللة برفق. استبدل الأشياء الباردة بأخرى ساخنة أو بمعاطف أو بطانيات جافة.</li>\n    <li> في حالة الحاجة إلى المزيد من التدفئة، فقم بذلك تدريجيًا. على سبيل المثال، ضع كمادات دافئة وجافة على منتصف الجسم والرقبة والصدر    . تقول مراكز مكافحة الأمراض والوقاية منها، إن هناك خيارًا آخر متمثلاً في استخدام البطانيات الكهربائية في حالة توافرها. إذا استخدمت زجاجات الماء الساخنة أو الكمادات الكيميائية الساخنة، فقم أولاً بلفها داخل منشفة قبل استخدامها.</li>\n    <li> اعرض على الشخص مشروبات ساخنة وسكرية وغير كحولية.</li>\n    <li> ابدأ عملية الإنعاش القلبي الرئوي إذا لم يُظهر الشخص أي علامات للحياة مثل التنفس أو السعال أو الحركة.</li>\n \n\n\n\n  </ul>\n</li>\n\n\n  </ul>\n\n</ion-content>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n'/*ion-inline-end:"F:\OneDrive\Band--Aid\src\pages\max-temperatures\max-temperatures.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]])
    ], MaxTemperaturesPage);
...
var MusculoskeletalInjuriesPage = /** @class */ (function () {
    ...
    MusculoskeletalInjuriesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-musculoskeletal-injuries',template:/*ion-inline-start:"F:\OneDrive\Band--Aid\src\pages\musculoskeletal-injuries\musculoskeletal-injuries.html"*/'<!--\n  Generated template for the MusculoskeletalInjuriesPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header dir="rtl">\n  <ion-navbar color="orange">\n    <button ion-button menuToggle class="menus">\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title> اصابات العضلات ومالفاصل  </ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n\n    <div class="con-deta">\n        <a href="#km">خلع المفاصل</a>\n        <a href="#ea">إصابات الفقرات</a>\n        <a href="#em"> التواء المفاصل </a>\n  \n        \n      </div>\n\n      \n  <ul class="main-ul" dir="rtl">\n<li>\n  <ul>\n    <p id="km">  خلع المفاصل</p>\n\n\n    <li> لا تحرك المفصل</li>\n    <li>ثبّت المفصل المصاب بجبيرة في وضعه السليم؛ ولا تحاول تحريك المفصل المخلوع أو إعادته بالقوة إلى مكانه؛ حيث يمكن أن يؤدي هذا إلى تلف المفصل والعضلات أو الأربطة أو الأعصاب أو الأوعية الدموية المحيطة.</li>\n<li>ضع ثلجًا على المفصل المصاب\n    يمكن أن يساعد ذلك في تقليل التورم عن طريق التحكم في النزيف الداخلي وتراكم السوائل في المفصل المصاب وحوله.</li>\n  </ul>\n</li>\n\n\n\n<li>\n\n  <ul>\n\n    <p id="ea">إصابات الفقرات</p>\n\n    <p>المعالجة</p>\n\n    <li>اتصل بخدمات الإسعاف فورا.</li>\n    <li>حافظ على ثبات الشخص. ضع مناشف ثقيلة على كلا جانبي الرقبة أو أمسك الرأس والرقبة للحيلولة دون تحركهما.</li>\n    <li>قدم أكبر قدر من الإسعافات الأولية دون تحريك رأس الشخص أو رقبته.</li>\n    <li>إذا لم يظهر على الشخص أي علامات لعمل الدورة الدموية (التنفس أو السعال أو الحركة)، فابدأ الإنعاش القلبي الرئوي لكن لا تحرك الرأس للخلف لفتح مجرى الهواء. \n    استخدم أصابعك للإمساك برفق بالفك ورفعه للأمام. \n    إذا توقف نبض الشخص، فابدأ بضغطات الصدر.</li>\n    <li>إذا كان الشخص المصاب يرتدي خوذة، فلا تنزعها عنه.</li>\n    <li> إذا تحتم عليك تدوير الشخص بسبب تعرضه للقيء أو الاختناق بسبب نقص تدفق الدم إلى الدماغ أو كونه عرضة لإصابة إضافية، فأنت بحاجة إلى وجود شخص آخر معك. حيث يكون أحدكما عند رأس الشخص والآخر على طول جانب الشخص المصاب، وتعملان معًا لإبقاء رأس الشخص ورقبته وظهره في وضع المحاذاة أثناء تدوير الشخص على جانبه.\n</li>\n\n  </ul>\n\n</li>\n\n\n\n<li>\n\n  <ul>\n\n    <p id="em">إلتواء المفاصل</p>\n<p>المعالجة</p>\n    \n<li>شد و وضع الجزء المصاب في وضع مريح.</li>\n<li> وضع كمادات باردة أو كيس ثلج لتخفيف التورم و الالم.</li>\n<li> لف المفصل برباط أو عصابة للضغط عليه.</li>\n<li> رفع الجزء المصاب فوق مستوى القلب.</li>\n<li>أطلب العون الطبي أو سيارة الإسعاف اذا لزم الامر. </li>\n\n  </ul>\n</li>\n\n\n  </ul>\n\n\n\n\n\n</ion-content>\n'/*ion-inline-end:"F:\OneDrive\Band--Aid\src\pages\musculoskeletal-injuries\musculoskeletal-injuries.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]])
...
var UnconsciousnessPage = /** @class */ (function () {
    ...
    UnconsciousnessPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-unconsciousness',template:/*ion-inline-start:"F:\OneDrive\Band--Aid\src\pages\unconsciousness\unconsciousness.html"*/'<!--\n  Generated template for the UnconsciousnessPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header dir="rtl">\n  <ion-navbar color="orange">\n    <button ion-button menuToggle class="menus">\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title> التسمم </ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n\n  \n    <div class="con-deta">\n        <a href="#sad">الصدمة</a>\n        <a href="#sad2">الذبحة الصدرية</a>\n        <a href="#naob">النوبة القلبية</a>\n        <a href="#sthart"> توقف القلب </a>\n        <a href="#stmok"> الجلطة الدماغية </a>\n        \n      </div>\n\n  <ul class="main-ul" dir="rtl">\n\n\n    <li>\n\n      <ul>\n\n        <p> التسمم الغذائي</p>\n        <p>الاعراض العامة</p>\n\n        <li>الغثيان،</li>\n        <li>التقيؤ،</li>\n        <li>الإسهال،</li>\n        <li> تقلصات في المعدة و الأمعاء\n        </li>\n        <li>الحمى و ظهور الدم في البراز.</li>\n\n\n\n        <hr>\n        <p>المعالجة</p>\n        <li>تخفيف أعراض التسمم الغذائي: يؤدي الاسهال و التقيؤ إلى فقدان السوائل في الجسم و كذا التعب</li>\n        <li> تناول بعض المأكولات كالموز، التفاح و الارز الابيض المسلوق.</li>\n        <li>شرب الكثير من السوائل لتجنب الجفاف خصوصا الماء و سوائل اخرى كالشاي و عصير الليمون.</li>\n        <li>الهدوء و الراحة خاصة و أن المصاب يحس بالضعف و التعب.</li>\n        <li>تجنب الادوية إلا أن وصفها الطبيب.</li>\n        <li> الاتصال بسيارة الاسعاف أو التوجه لأقرب مستشفى.</li>\n\n\n\n\n\n\n      </ul>\n\n    </li>\n\n    <hr>\n\n\n    <li>\n\n      <ul>\n\n        <p>التسمم الدوائي</p>\n\n        <p>الاعراض العامة</p>\n        <li>تختلف أعراض التسمم الدوائي بحسب الدواء و الكمية المستهلكة و في الغالب لا يحدث القيء مباشرة و لكن يجب أن\n          تتوقع حدوثه كما أن حدقتا عيني المصاب تكونان متسعتين أو منقبضتين بشكل شاذ.</li>\n\n\n\n        <hr>\n\n\n        <p>المعالجة</p>\n\n        <li>فحص الوظائف الحيوية( التنفس النبض و الوعي).</li>\n        <li>تسريح و فتح المسالك الهوائيية في حالة الاغماء.</li>\n        <li>سؤال المصاب أو البحث عن الدواء المسبب للتسمم لأخده الدواء للطبيب.</li>\n        <li>إن كان طفلا حاول إزالة ما لم يتم بلعه من فمه.</li>\n        <li> ينبغي معرفة متى قام بتناوله و كم العدد أو الكمية. </li>\n        <li>لا تحث المصاب على التقيؤ إن لم يكن واعيا و حتى لو كان واعيا.</li>\n        <li>طلب الإسعاف للتوجه للمستشفى.</li>\n        <li>إن إستحال نقل المصاب لسبب من الاسباب فقم بالاتي:\n          - إن كان واعيا يمكن في هذه الحالة محاولة إحداث التقيؤ بوضع الأصبع في الحلق مع مراعاة عدم إنسداد مسالكه\n          الهوائية.</li>\n        <li> يمكن إعطائه القليل من الحليب بعد كل قيء. </li>\n        <li> إن كان غير واع اجعله في الافاقة و لا تقم بإحداث التقيؤ حتى يستفيق.</li>\n\n\n\n      </ul>\n\n    </li>\n\n\n\n    <li>\n\n      <ul>\n        <p> التسمم بغاز أحادي أكسيد الكربون</p>\n\n        <li> صداع الراس.</li>\n        <li>الدوخة.</li>\n        <li>الغثيان.</li>\n        <li>كما أن غاز أول أكسيد الكربون عندما يصل في الدم, تزداد الأعراض سوءا ويمكن أن تشمل:</li>\n        <li>الارتباك والشعور بالنعاس.</li>\n        <li>سرعة التنفس، سرعة ضربات القلب، أو ألم في الصدر.</li>\n        <li> مشاكل في الرؤية.</li>\n        <li>الغيبوبة.</li>\n\n\n        <hr>\n\n        <p>المعالجة العامة</p>\n\n        <li>فتح الابواب و النوافذ لتهوية المكان, سد أو إغلاق مصدر الغاز إن أمكن, ثم إبعاد أو جر المصاب إلى مكان آمن و\n          به هواء منعش و اطلب سيارة الاسعاف.</li>\n        <li>بعد إبعاده لمكان آمن يجب القيام بأساسيات الاسعاف (فتح مجرى الهواء, فحص التنفس و النبض).\n        </li>\n        <li>إن كان المصاب فاقد للوعي تحقق من تنفسه و قم بالإنعاش القلبي الرئوي إذا توقف التنفس.\n        </li>\n        <li>ان كان يتنفس و مغمى عليه فقم بوضعه في وضعية الإفاقة</li>\n        <li>نقل المصاب للمستشفى.</li>\n\n      </ul>\n\n    </li>\n\n\n  </ul>\n\n\n\n</ion-content>'/*ion-inline-end:"F:\OneDrive\Band--Aid\src\pages\unconsciousness\unconsciousness.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]])
    ], UnconsciousnessPage);
...
var WoundsPage = /** @class */ (function () {
    function WoundsPage(navCtrl, navParams, domSanitizer) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.domSanitizer = domSanitizer;
        this.videos = {
...
var PrinciplesPage = /** @class */ (function () {
    ...
    PrinciplesPage = PrinciplesPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-principles',template:/*ion-inline-start:"F:\OneDrive\Band--Aid\src\pages\principles\principles.html"*/'<ion-header>\n  <ion-navbar color="orange">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title   > المبادئ الرئيسية للاسعافات  </ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n\n\n\n  <ul class="main-ul" dir="rtl">\n\n    <p>عموما تعتمد الاسعافات الاولية على القاعدة التالية: الحماية, الاتصال بالطوارئ و تقديم الاسعاف اللازم. </p>\n   \n\n    <li>\n\n      <ul>\n        <p>الحماية</p>\n        <p>الحماية من أي خطر أول شيء يجب التفكير فيه قبل و أثناء إسعاف أي حالة مهما كانت ويكون ذلك ب:  </p>\n      \n        <li>حماية المسعف أو المنقذ نفسه (يجب أخد الحيطة و الحذر قبل التوجه للمصاب).\n        </li>\n        <li>حماية المصاب إما بإبعاده أو بإزالة الخطر.\n        </li>\n        <li>و كذا حماية الناس المحيطين به أو الجمهور.\n        </li>\n\n        \n<p>الاتصال بالاسعاف أو بالطوارئ:</p>\n<li>في الحالات التي تستدعي سيارة الاسعاف أو الطوارئ يجب التعجيل بالإتصال بهم ليصلوا بسرعة فكل دقيقة غالية.</li>\n\n\n<p>\n    تقديم الاسعاف اللازم للمصاب:\n    \n</p>\n\n<li>\nكل حالة طارئة تستلزم إجراءات خاصة لإسعافها في إنتظار وصول سيارة الاسعاف إن لزم الأمر ذلك. \n</li>\n        \n      </ul>\n\n    </li>\n\n\n  </ul>\n\n\n\n</ion-content>'/*ion-inline-end:"F:\OneDrive\Band--Aid\src\pages\principles\principles.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]])
    ], PrinciplesPage);
